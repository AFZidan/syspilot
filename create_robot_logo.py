...
def create_robot_logo():
    ...
    draw.line([antenna_x, antenna_y1, antenna_x, antenna_y2], fill=outline_color, width=4)
    
    # Antenna tip (circle)
    tip_radius = 8
    draw.ellipse(
        [antenna_x - tip_radius, antenna_y2 - tip_radius,
         antenna_x + tip_radius, antenna_y2 + tip_radius],
        fill=outline_color
    )
    ...
    draw.rounded_rectangle(
        [left_leg_x - leg_width // 2, leg_y, left_leg_x + leg_width // 2, leg_y + leg_height],
        radius=12,
        fill=robot_blue,
        outline=outline_color,
        width=4
    ...
    draw.rounded_rectangle(
        [right_leg_x - leg_width // 2, leg_y, right_leg_x + leg_width // 2, leg_y + leg_height],
        radius=12,
        fill=robot_blue,
        outline=outline_color,
        width=4
    ...
    # Left foot
    draw.rounded_rectangle(
        [left_leg_x - foot_width // 2, foot_y, left_leg_x + foot_width // 2, foot_y + foot_height],
        radius=8,
        fill=robot_dark_blue,
        outline=outline_color,
        width=3
    ...
    # Right foot
    draw.rounded_rectangle(
        [right_leg_x - foot_width // 2, foot_y, right_leg_x + foot_width // 2, foot_y + foot_height],
        radius=8,
        fill=robot_dark_blue,
        outline=outline_color,
        width=3
    ...
    # Wrench handle
    draw.line(
        [wrench_x, wrench_y, wrench_x + wrench_length * 0.7, wrench_y - wrench_length * 0.7],
        fill=wrench_gray,
        width=wrench_width
    )
    ...
    draw.polygon([
        ...
        (head_x + 15, head_y + head_size // 2 + 8),
        (head_x - 5, head_y + head_size // 2),
    ], fill=wrench_gray, outline=outline_color, width=2)
...
def main():
    ...
    # Save main logo
    logo.save('/var/www/Zidan/Ubuntu_Cleanup_App/assets/syspilot_logo_new.png', 'PNG', quality=95)
    ...
    icons[256].save('/var/www/Zidan/Ubuntu_Cleanup_App/assets/syspilot_icon_new.png', 'PNG', quality=95)
    ...
    banner.save('/var/www/Zidan/Ubuntu_Cleanup_App/assets/syspilot_banner_new.png', 'PNG', quality=95)
