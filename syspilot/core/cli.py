...
class SysPilotCLI:
    ...
    def show_top_processes(self):
        ...
        try:
            ...
            if processes:
                print(f"{'PID':<8} {'Name':<20} {'CPU%':<8} {'Memory%':<8} {'User':<12}")
                print("-" * 50)
    ...
    def show_disk_usage(self):
        ...
        try:
            ...
            if partitions:
                print(f"{'Device':<20} {'Mount':<15} {'Type':<8} {'Size':<10} {'Used':<8} {'Free':<10} {'Use%':<6}")
                print("-" * 80)
    ...
    def show_cleanup_preview(self):
        ...
        try:
            ...
            print(f"Estimated space to free: {self._format_bytes(preview['estimated_space'])}")
            ...
            if preview['temp_files'] or preview['cache_files']:
                ...
                if show_details == 'y':
                    ...
                    if len(preview['cache_files']) > 20:
                        print(f"  ... and {len(preview['cache_files']) - 20} more files")
    ...
    def reset_settings(self):
        ...
        confirm = input("\nAre you sure you want to reset all settings to defaults? (y/n): ").lower().strip()
        if confirm == 'y':
