...
class SchedulingService:
    ...
    def add_schedule(self, schedule_id: str, schedule_type: str, 
                    frequency: str, time_str: str = None, 
                    cleanup_types: List[str] = None) -> bool:
        """
    ...
    def _add_to_scheduler(self, schedule_config: Dict) -> None:
        ...
        try:
            ...
            cleanup_types = schedule_config.get("cleanup_types", ["temp", "cache", "logs"])
    ...
    def _run_scheduled_cleanup(self, schedule_id: str, cleanup_types: List[str]) -> None:
